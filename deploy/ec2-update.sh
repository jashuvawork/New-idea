...
if [ "${SKIP_ENV_MERGE:-0}" != "1" ] && [ -f deploy/env.production.template ]; then
  ...
  SYNC_ENV_KEYS=(
    ...
    EOD_REPLAY_PER_TRADE_MAX_LOSS_INR
    EOD_REPORT_MAX_CONCURRENT
    EOD_REPORT_SAME_SIDE_CAP
    EARLY_MOMENTUM_IGNITION_ENABLED
    EARLY_MOMENTUM_IGNITION_ALLOW_BUILDING
    EARLY_MOMENTUM_IGNITION_STRONG_VELOCITY_3S
    EARLY_MOMENTUM_IGNITION_STRONG_VOL_SURGE
    EARLY_MOMENTUM_IGNITION_TIGHT_BASE_RANGE_PCT
    COIL_ARMED_LOW_SCORE_ENTRY_ENABLED
    NEAR_BASE_LANE_MIN_QUALITY
    NEAR_BASE_LANE_STRONG_SCORE
    ...
    EXPLOSION_POST_PEAK_CHASE_SESSION_ENABLED
