...
class Settings(BaseSettings):
    ...
    # CALL-only local-base reversal prediction. This promotes a bullish option leg only
    # after a real premium base, live index momentum turn, premium acceleration and volume
    # agree. It never bypasses risk, fake-trap, chase or execution-chart safety.
