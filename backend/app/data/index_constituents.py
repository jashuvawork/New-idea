...
NIFTY50: list[ConstituentDef] = [
    ...
    {"symbol": "TATAMOTORS", "name": "Tata Motors", "weight": 1.4, "isin": "INE155A01022", "exchange": "NSE_EQ"},
...
SENSEX30: list[ConstituentDef] = [
    ...
    {"symbol": "TATAMOTORS", "name": "Tata Motors", "weight": 1.6, "isin": "INE155A01022", "exchange": "BSE_EQ"},
