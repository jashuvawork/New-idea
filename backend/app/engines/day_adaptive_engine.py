...
def build_day_adaptive_profile(
    ...
    *,
    ...
    if day_type == "WORST":
        profile.preferred_modes = ["quick_sideways", "explosion"]
        ...
        profile.playbook = [
            "Worst day — quick sideways primary (+3/−2), elite explosions only",
            "Cap rank floor — still trade, smaller size, no regular scalps",
        ]
    elif day_type == "CHOP":
